...
public class RedisSessionManager extends ManagerBase implements Lifecycle
{
    ...
    public String getSessionPersistPolicies()
    {
        ...
        Iterator<SessionPersistPolicy> iter = this.sessionPersistPoliciesSet.iterator();
        SessionPersistPolicy policy = null;
    ...
    public void setSessionPersistPolicies(String sessionPersistPolicies)
    {
        ...
        {
            policy = SessionPersistPolicy.fromName(policyName);
    ...
    public Session createSession(String requestedSessionId)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                while (jedis.setnx(sessionId.getBytes(), NULL_SESSION) == 0L); // 1 = key set;
            ...
            if (null != session)
            {
                ...
                {
                    LOG.error("Error saving newly created session: " + ex.toString(), ex);
    ...
    public void add(Session session)
    {
        ...
        {
            LOG.warn("Unable to add to session manager store: " + ex.toString(), ex);
    ...
    protected boolean saveInternal(Jedis jedis, Session session, boolean forceSave) throws IOException
    {
        ...
        byte[] binaryId = null;
        Boolean isCurrentSessionPersisted = false;
        SessionSerializationMetadata sessionSerializationMetadata = null;
        byte[] originalSessionAttributesHash = null;
        byte[] sessionAttributesHash = null;
        SessionSerializationMetadata updatedSerializationMetadata = null;
        ...
        try
        {
            ...
            if (LOG.isTraceEnabled())
            {
                ...
                en = redisSession.getAttributeNames();
                while (en.hasMoreElements())
                {
                    LOG.trace("  " + en.nextElement());
                }
            ...
            binaryId = redisSession.getId().getBytes();
            sessionSerializationMetadata = currentSessionSerializationMetadata.get();
                    ...
                    || !Arrays.equals(originalSessionAttributesHash, (sessionAttributesHash = serializer.attributesHashFrom(redisSession))))
            {
                ...
                updatedSerializationMetadata = new SessionSerializationMetadata();
    ...
    public void afterRequest()
    {
        ...
        if (redisSession != null)
        {
            ...
            {
                LOG.error("Error storing/removing session: " + e.toString(), e);
            }
            finally
            {
