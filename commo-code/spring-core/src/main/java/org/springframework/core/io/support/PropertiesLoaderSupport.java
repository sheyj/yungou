...
import cn.wonhigh.o2o.springframework.core.io.support.ConfigCenterLoader;
...
public abstract class PropertiesLoaderSupport {
	...
	private ConfigCenterLoader configCenterLoader = new ConfigCenterLoader();
		...
		if (this.locations != null) {
			for (Resource location : this.locations) {
				...
				try {
					...
					// 从配置中心加载配置
					configCenterLoader.loadPropertiesFromConfigCenter(props);
				}
